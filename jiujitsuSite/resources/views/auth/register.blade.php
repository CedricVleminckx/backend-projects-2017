@extends('layouts.app')
@section('title', 'Registreren Jiujitsu')
@section('content')
<div class="container">
    <div class="row">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('leeftijd') ? ' has-error' : '' }}">
                            <label for="leeftijd" class="col-md-4 control-label">Leeftijd</label>

                            <div class="col-md-6">
                                <input id="leeftijd" type="text" class="form-control" name="leeftijd" value="{{ old('leeftijd') }}" required autofocus>
